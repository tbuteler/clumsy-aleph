...
return [
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | Whether to inject Aleph information into the logs
     |
     */

    'enabled' => env('ALEPH_ENABLED', false),
    ...
    'enforce-endpoint-https' => env('ALEPH_ENFORCE_ENDPOINT_HTTPS', true),
    ...
    'log-endpoint-response' => env('ALEPH_LOG_ENDPOINT_RESPONSE', true),
